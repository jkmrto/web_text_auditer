defmodule WebTextAuditerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(WebTextAuditerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(WebTextAuditerWeb.Gettext, "errors", msg, opts)
    # end
